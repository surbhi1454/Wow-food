    ...
    <div class="wrapper">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
             ...
             <table class="tbl-30">
                 ...
                 <tr>
                     <td>Description: </td>
                     <td><textarea name="description" cols="23" rows="3"></textarea></td>
                 </tr>
                 <tr>
                     <td>Price: </td>
        ...
        <?php
            if(isset($_POST['submit'])){
               ...
               if(isset($_POST['active'])){
                ...
                $active = "No";  //setting default values as no
               }
               ...
               $sql2 = "INSERT INTO tbl_food SET
                ...
                if($res2 == TRUE){
                    ...
                    $_SESSION['add'] = "<div class='lerror'>Failed to Add Food.</div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                }
